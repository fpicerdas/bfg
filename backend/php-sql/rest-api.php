...
$config["abs_url_images"] 		= "http://abbayosua.host/apps/bfg/media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://abbayosua.host/apps/bfg/media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://abbayosua.host/apps/bfg/media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://abbayosua.host/apps/bfg/media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	
	...
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Batam Fiber Glass" ;
