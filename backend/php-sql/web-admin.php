 ...
 * @author Abba Yosua <abbsiagian@gmail.com>
 * @copyright Abba Yosua 2019
 * @package batam_fiber_glass
 * 
 * 
...
$config["user"]			= "abbahost_bfg" ; 		//Username SQL
...
$config["onesignal-appkey"]			= "OTIxNTE3NTMtZmJiYi00NjI1LTk1MjctODA3Njk4YzlmY2Rj" ; 		//Your OneSignal AppKey
/** CONFIG:END **/
...
if($_SESSION["IS_ADMIN"]==true){
	...
	$tags_html .= "</ul>" ;
	$tags_html .= "<h1 class=\"text-muted\">Batam Fiber Glass</h1>" ;
	$tags_html .= "<p>Batam Fiber Glass App</p>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "<div class=\"container-fluid\">" ;
	...
	switch($_GET["table"]){
		case "home":
					$tags_html .= "<h4 class=\"page-title\">Batam Fiber Glass</h4>" ;
					$tags_html .= "<div class=\"row\">" ;
...
<div class="form-group">
	...
	<input class="btn btn-primary" type="submit" name="edit" />
		...
		$tags_html .= "<div class=\"container-fluid\">" ;
		$tags_html .= "<div class=\"row\">" ;
		$tags_html .= "<div class=\"col-md-12\"><p class=\"text-left navbar-text\">Copyright &copy; Abba Yosua 2019 - All Rights Reserved</p></div>" ;
		$tags_html .= "</div>" ;
